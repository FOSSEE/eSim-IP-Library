/* This is cfunc.mod file auto generated by gen_con_info.py
        ...
        #include <math.h>
        #include <string.h>
        #include "sim_main_decode48.h"

        
void cm_decode48(ARGS) 
{
    ...
    if(INIT)
    {
        ...
        foodecode48(0,inst_count);
        /* Allocate storage for output ports and set the load for input ports */

        
        port_in=PORT_SIZE(in);
		...
		int Ii;
		for(Ii=0;Ii<PORT_SIZE(in);Ii++)
		{
			LOAD(in[Ii])=PARAM(input_load); 
		}
